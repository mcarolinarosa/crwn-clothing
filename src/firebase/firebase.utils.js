...
export const googleProvider = new firebase.auth.GoogleAuthProvider(); //access to google auth provider class from the authentication library
googleProvider.setCustomParameters({ prompt: "select_account" }); //we want to always trigger the google pop up whenever we use this google auth provider for authentication and sign in
